...
export default function App() {
  ...
  useEffect(() => {
    const savedName = localStorage.getItem("jobiq_name");
    const savedProf = localStorage.getItem("jobiq_profession");
    if (savedName && savedProf) {
      setUserName(savedName);
      setProfession(JSON.parse(savedProf));
      setOnboarded(true);
    }
  }, []);
