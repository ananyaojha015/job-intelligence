...
PROFESSION_CATEGORIES = {
    "software-development": ["software-dev", "javascript", "python"],
    "ai-ml": ["machine-learning", "data"],
    "data-science": ["data", "machine-learning"],
    "cloud-devops": ["devops-sysadmin", "system-admin"],
    "uiux-design": ["design"],
    "finance-fintech": ["finance"],
    "digital-marketing": ["marketing"],
    "cybersecurity": ["devops-sysadmin"],
    "mobile-development": ["software-dev"],
    "healthcare-tech": ["machine-learning", "data"],
    "teaching-edtech": ["education"],
    "banking-finance": ["finance"],
    "marketing": ["marketing"],
}

# Default categories (used when no profession selected)
CATEGORIES = [
    "software-dev",
    "data",
    "devops-sysadmin",
